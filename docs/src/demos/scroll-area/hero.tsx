import * as ScrollArea from "@danielfrg/ui/scroll-area";
		...
		<ScrollArea.Root class={styles.root}>
			<ScrollArea.Viewport class={styles.viewport}>
				...
				<p class={styles.paragraph}>
					...
					More recently, vernacular architecture has been examined by designers
					and the building industry in an effort to be more energy conscious
					with contemporary design and construction — part of a broader
