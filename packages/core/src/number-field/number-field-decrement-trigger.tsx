...
export interface NumberFieldDecrementTriggerRenderProps
  extends NumberFieldDecrementTriggerCommonProps, NumberFieldVaryTriggerRenderProps {}

export type NumberFieldDecrementTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NumberFieldDecrementTriggerOptions & Partial<NumberFieldDecrementTriggerCommonProps<ElementOf<T>>>
...
export function NumberFieldDecrementTrigger<T extends ValidComponent = "button">(
  ...
  return (
    <NumberFieldVaryTrigger<
      Component<Omit<NumberFieldDecrementTriggerRenderProps, keyof NumberFieldVaryTriggerRenderProps>>
    >
