import { callHandler, composeEventHandlers, mergeDefaultProps, mergeRefs } from "../utils"
...
import { type ElementOf, Polymorphic, type PolymorphicCallbackProps, type PolymorphicProps } from "../polymorphic"
...
export interface NumberFieldInputCommonProps<T extends HTMLElement = HTMLInputElement> {
  id: string
  ref: T | ((el: T) => void)
...
export interface NumberFieldInputRenderProps extends NumberFieldInputCommonProps, SpinButton.SpinButtonRootRenderProps {
  type: "text"
  value: string
...
export type NumberFieldInputProps<T extends ValidComponent | HTMLElement = HTMLInputElement> = NumberFieldInputOptions &
    ...
    <SpinButton.Root<
      Component<
        Omit<
          ...
          keyof SpinButton.SpinButtonRootRenderProps | "value" | "required" | "disabled" | "readOnly"
        >
      >
    >
      type="text"
      ...
      as={(props) => (
        <Polymorphic<
          Omit<
            Pick<NumberFieldInputRenderProps, "required" | "disabled" | "readOnly" | "value">,
