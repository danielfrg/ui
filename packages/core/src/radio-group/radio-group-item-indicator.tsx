...
export interface RadioGroupItemIndicatorCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
}

export interface RadioGroupItemIndicatorRenderProps extends RadioGroupItemIndicatorCommonProps, RadioGroupItemDataSet {}

export type RadioGroupItemIndicatorProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  RadioGroupItemIndicatorOptions & Partial<RadioGroupItemIndicatorCommonProps<ElementOf<T>>>
