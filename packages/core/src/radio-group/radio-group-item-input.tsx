...
import { type JSX, type ValidComponent, createEffect, createSignal, on, onCleanup, splitProps } from "solid-js"

import { combineStyle } from "@solid-primitives/props"
import { useFormControlContext } from "../form-control"
import { type ElementOf, Polymorphic, type PolymorphicProps } from "../polymorphic"
import { useRadioGroupContext } from "./radio-group-context"
import { type RadioGroupItemDataSet, useRadioGroupItemContext } from "./radio-group-item-context"

export interface RadioGroupItemInputOptions {}

export interface RadioGroupItemInputCommonProps<T extends HTMLElement = HTMLInputElement> {
  id: string
  ref: T | ((el: T) => void)
...
export interface RadioGroupItemInputRenderProps extends RadioGroupItemInputCommonProps, RadioGroupItemDataSet {
  type: "radio"
  name: string
  value: string
  checked: boolean
...
export type RadioGroupItemInputProps<T extends ValidComponent | HTMLElement = HTMLInputElement> =
  RadioGroupItemInputOptions & Partial<RadioGroupItemInputCommonProps<ElementOf<T>>>
