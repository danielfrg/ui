...
export interface CollapsibleTriggerRenderProps extends CollapsibleTriggerCommonProps, Button.ButtonRootRenderProps {
  "aria-expanded": boolean
  "aria-controls": string | undefined
}

export type CollapsibleTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = CollapsibleTriggerOptions &
