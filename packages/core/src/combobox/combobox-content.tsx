import { focusWithoutScrolling, mergeRefs } from "../utils"
...
export interface ComboboxContentRenderProps
  extends ComboboxContentCommonProps, DismissableLayerRenderProps, ComboboxDataSet {}

export type ComboboxContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = ComboboxContentOptions &
  Partial<ComboboxContentCommonProps<ElementOf<T>>>
...
export function ComboboxContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, ComboboxContentProps<T>>) {
  ...
  return (
    <Show when={context.contentPresent()}>
      <Popper.Positioner>
        <DismissableLayer<Component<Omit<ComboboxContentRenderProps, keyof DismissableLayerRenderProps>>>
          ref={mergeRefs((el) => {
