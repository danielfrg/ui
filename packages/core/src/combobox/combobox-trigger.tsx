...
import { type OverrideComponentProps, callHandler, mergeDefaultProps, mergeRefs } from "../utils"
...
export interface ComboboxTriggerRenderProps
  extends ComboboxTriggerCommonProps, ComboboxDataSet, Button.ButtonRootRenderProps {
...
export type ComboboxTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = ComboboxTriggerOptions &
  Partial<ComboboxTriggerCommonProps<ElementOf<T>>>
...
export function ComboboxTrigger<T extends ValidComponent = "button">(
  ...
  return (
    <Button.Root<Component<Omit<ComboboxTriggerRenderProps, keyof Button.ButtonRootRenderProps>>>
