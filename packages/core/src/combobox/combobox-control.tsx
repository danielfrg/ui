import { type OverrideComponentProps, isFunction, mergeRefs } from "../utils"
import { type Accessor, type JSX, type ValidComponent, children, splitProps } from "solid-js"
...
export interface ComboboxControlCommonProps<T extends HTMLElement = HTMLElement> {
  ref: T | ((el: T) => void)
}

export interface ComboboxControlRenderProps extends ComboboxControlCommonProps, FormControlDataSet, ComboboxDataSet {
...
> = ComboboxControlOptions<Option> & Partial<ComboboxControlCommonProps<ElementOf<T>>>
...
export function ComboboxControl<Option, T extends ValidComponent = "div">(
  ...
  const [local, others] = splitProps(props as ComboboxControlProps<Option>, ["ref", "children"])
...
interface ComboboxControlChildProps<Option> extends Pick<ComboboxControlOptions<Option>, "children"> {
  state: ComboboxControlState<Option>
}

function ComboboxControlChild<Option>(props: ComboboxControlChildProps<Option>) {
