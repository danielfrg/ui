...
import { callHandler, contains, mergeDefaultProps, mergeRefs } from "../utils"
...
export interface ComboboxInputCommonProps<T extends HTMLElement = HTMLInputElement> {
  id: string
  ref: T | ((el: T) => void)
...
export interface ComboboxInputRenderProps extends ComboboxInputCommonProps, FormControlDataSet {
...
export type ComboboxInputProps<T extends ValidComponent | HTMLElement = HTMLInputElement> = ComboboxInputOptions &
  Partial<ComboboxInputCommonProps<ElementOf<T>>>
...
export function ComboboxInput<T extends ValidComponent = "input">(props: PolymorphicProps<T, ComboboxInputProps<T>>) {
  ...
  const [local, formControlFieldProps, others] = splitProps(
    mergedProps,
    ["ref", "disabled", "onClick", "onInput", "onKeyDown", "onFocus", "onBlur", "onTouchEnd"],
    FORM_CONTROL_FIELD_PROP_NAMES,
  )
