...
export interface ComboboxListboxOptions<Option, OptGroup = never> extends Pick<
  Listbox.ListboxRootOptions<Option, OptGroup>,
  "scrollRef" | "scrollToItem" | "children"
> {}

export interface ComboboxListboxCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
}

export interface ComboboxListboxRenderProps extends ComboboxListboxCommonProps, Listbox.ListboxRootRenderProps {
...
> = ComboboxListboxOptions<Option, OptGroup> & Partial<ComboboxListboxCommonProps<ElementOf<T>>>

/**
 * Contains all the items of a `Combobox`.
 */
export function ComboboxListbox<Option = any, OptGroup = never, T extends ValidComponent = "ul">(
  ...
  return (
    <Listbox.Root<Option, OptGroup, Component<Omit<ComboboxListboxRenderProps, keyof Listbox.ListboxRootRenderProps>>>
