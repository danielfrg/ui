...
export interface ComboboxIconRenderProps extends ComboboxIconCommonProps, ComboboxDataSet {
  "aria-hidden": "true"
}

export type ComboboxIconProps<T extends ValidComponent | HTMLElement = HTMLElement> = ComboboxIconOptions &
  Partial<ComboboxIconCommonProps<ElementOf<T>>>
 ...
 */
export function ComboboxIcon<T extends ValidComponent = "span">(props: PolymorphicProps<T, ComboboxIconProps<T>>) {
  const context = useComboboxContext()

  const mergedProps = mergeDefaultProps({ children: "▼" }, props as ComboboxIconProps)
