import { contains, focusWithoutScrolling, mergeDefaultProps, mergeRefs } from "../utils"
...
export interface PopoverContentRenderProps
  extends PopoverContentCommonProps, DismissableLayerRenderProps, PopoverDataSet {
  role: "dialog"
  tabIndex: -1
