import { type MaybeAccessor, access, mergeDefaultProps } from "../utils"
...
export const FORM_CONTROL_FIELD_PROP_NAMES = ["id", "aria-label", "aria-labelledby", "aria-describedby"] as const
...
export function createFormControlField(props: CreateFormControlFieldProps) {
  ...
  return {
    fieldProps: {
      ...
      ariaDescribedBy: () => context.getAriaDescribedBy(access(mergedProps["aria-describedby"])) as string | undefined,
    },
  }
}
