...
import { type MaybeAccessor, type ValidationState, access, createGenerateId, mergeDefaultProps } from "../utils"
import { type Accessor, createMemo, createSignal, createUniqueId } from "solid-js"

import { createRegisterId } from "../primitives"
import type { FormControlContextValue, FormControlDataSet } from "./form-control-context"
...
export const FORM_CONTROL_PROP_NAMES = ["id", "name", "validationState", "required", "disabled", "readOnly"] as const
