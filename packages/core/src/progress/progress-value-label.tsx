...
export interface ProgressValueLabelRenderProps
  extends MeterValueLabelRenderProps, ProgressValueLabelCommonProps, ProgressDataSet {}

export type ProgressValueLabelProps<T extends ValidComponent | HTMLElement = HTMLElement> = ProgressValueLabelOptions &
...
export function ProgressValueLabel<T extends ValidComponent = "div">(
  ...
  return (
    <Meter.ValueLabel<Component<Omit<ProgressValueLabelRenderProps, keyof MeterValueLabelRenderProps>>>
      {...context.dataset()}
