 ...
 */
export function DialogOverlay<T extends ValidComponent = "div">(props: PolymorphicProps<T, DialogOverlayProps<T>>) {
  const context = useDialogContext()

  const [local, others] = splitProps(props as DialogOverlayProps, ["ref", "style", "onPointerDown"])
