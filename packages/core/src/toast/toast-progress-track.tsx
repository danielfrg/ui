...
export interface ToastProgressTrackCommonProps<T extends HTMLElement = HTMLElement> {}
...
export type ToastProgressTrackProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToastProgressTrackOptions &
