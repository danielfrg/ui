...
import { callHandler, createGenerateId, mergeDefaultProps, mergeRefs } from "../utils"
import {
  type JSX,
  Show,
  type ValidComponent,
...
export function ToastRoot<T extends ValidComponent = "li">(props: PolymorphicProps<T, ToastRootProps<T>>) {
...
function isDeltaInDirection(delta: { x: number; y: number }, direction: ToastSwipeDirection, threshold = 0) {
