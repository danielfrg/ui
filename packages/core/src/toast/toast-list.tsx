...
import { callHandler, contains, focusWithoutScrolling, getDocument, getWindow, mergeRefs } from "../utils"
import { For, type JSX, type ValidComponent, createEffect, on, onCleanup, splitProps } from "solid-js"
...
export type ToastListProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToastListOptions &
  Partial<ToastListCommonProps<ElementOf<T>>>

/**
 * The list containing all rendered toasts.
 * Must be inside a `Toast.Region`.
 */
export function ToastList<T extends ValidComponent = "ol">(props: PolymorphicProps<T, ToastListProps<T>>) {
