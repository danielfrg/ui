...
export interface ScrollAreaThumbCommonProps<T extends HTMLElement = HTMLElement> {
  ref: T | ((el: T) => void)
...
export interface ScrollAreaThumbRenderProps extends ScrollAreaThumbCommonProps {
  "data-orientation": "vertical" | "horizontal"
}

export type ScrollAreaThumbProps<T extends ValidComponent | HTMLElement = HTMLElement> = ScrollAreaThumbOptions &
  Partial<ScrollAreaThumbCommonProps<ElementOf<T>>>

/**
 * The draggable thumb inside a scrollbar.
 * Must be a child of ScrollArea.Scrollbar.
 */
export function ScrollAreaThumb<T extends ValidComponent = "div">(props: PolymorphicProps<T, ScrollAreaThumbProps<T>>) {
  const context = useScrollAreaContext()

  const [local, others] = splitProps(props as ScrollAreaThumbProps, ["ref", "style"])
