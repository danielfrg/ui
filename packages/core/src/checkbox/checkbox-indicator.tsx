...
export interface CheckboxIndicatorCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
}

export interface CheckboxIndicatorRenderProps
  extends CheckboxIndicatorCommonProps, FormControlDataSet, CheckboxDataSet {}

export type CheckboxIndicatorProps<T extends ValidComponent | HTMLElement = HTMLElement> = CheckboxIndicatorOptions &
