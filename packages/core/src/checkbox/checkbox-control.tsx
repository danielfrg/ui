...
export interface CheckboxControlCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  onClick: JSX.EventHandlerUnion<T, MouseEvent>
  onKeyDown: JSX.EventHandlerUnion<T, KeyboardEvent>
}

export interface CheckboxControlRenderProps extends CheckboxControlCommonProps, FormControlDataSet, CheckboxDataSet {}

export type CheckboxControlProps<T extends ValidComponent | HTMLElement = HTMLElement> = CheckboxControlOptions &
  Partial<CheckboxControlCommonProps<ElementOf<T>>>
