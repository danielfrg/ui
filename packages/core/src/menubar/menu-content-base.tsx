import { type Orientation, callHandler, composeEventHandlers, contains, mergeDefaultProps, mergeRefs } from "../utils"
import {
  type Component,
  type JSX,
  Show,
...
export interface MenuContentBaseRenderProps
  extends MenuContentBaseCommonProps, DismissableLayerRenderProps, MenuDataSet {
  role: "menu"
  ...
  return (
    <Show when={context.contentPresent()}>
      <Show
        ...
        fallback={
          <Polymorphic<MenuContentBaseRenderProps> as="div" {...context.dataset()} {...commonAttributes} {...others} />
        }
      >
        <Popper.Positioner>
