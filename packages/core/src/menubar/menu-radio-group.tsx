...
import { type Component, type ValidComponent, createUniqueId, splitProps } from "solid-js"
...
export type MenuRadioGroupProps<
  ...
  TValue = string,
> = MenuRadioGroupOptions<TValue> & Partial<MenuRadioGroupCommonProps<ElementOf<T>>>
