import { type Orientation, composeEventHandlers, mergeRefs } from "../utils"
...
import { type MenuBarDataSet, useMenuBarContext } from "../menubar/menu-bar-context"
...
export interface NavigationMenuViewportRenderProps
  extends NavigationMenuViewportCommonProps, DismissableLayerRenderProps, MenuBarDataSet {
  "data-orientation": Orientation
}

export type NavigationMenuViewportProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NavigationMenuViewportOptions & Partial<NavigationMenuViewportCommonProps<ElementOf<T>>>
