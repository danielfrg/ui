...
export interface NavigationMenuPortalProps extends ComponentProps<typeof Portal> {}
  ...
  return (
    <Show when={context.viewportPresent()}>
      <Show when={menuContext.contentPresent()}>
        <Portal mount={menuContext.parentMenuContext() == null ? context.viewportRef() : undefined} {...props} />
      </Show>
    </Show>
  )
}
