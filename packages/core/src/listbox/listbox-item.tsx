...
import { type CollectionNode, createRegisterId, getItemCount } from "../primitives"
import { createSelectableItem } from "../selection"
import { useListboxContext } from "./listbox-context"
import { ListboxItemContext, type ListboxItemContextValue, type ListboxItemDataSet } from "./listbox-item-context"
...
export interface ListboxItemRenderProps extends ListboxItemCommonProps, ListboxItemDataSet {
  role: "option"
...
export type ListboxItemProps<T extends ValidComponent | HTMLElement = HTMLElement> = ListboxItemOptions &
  Partial<ListboxItemCommonProps<ElementOf<T>>>

/**
 * An item of the listbox.
 */
export function ListboxItem<T extends ValidComponent = "li">(props: PolymorphicProps<T, ListboxItemProps<T>>) {
  ...
  const mergedProps = mergeDefaultProps({ id: defaultId }, props as ListboxItemProps)
