...
export interface ListboxItemDescriptionCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
}

export interface ListboxItemDescriptionRenderProps extends ListboxItemDescriptionCommonProps, ListboxItemDataSet {}

export type ListboxItemDescriptionProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  ListboxItemDescriptionOptions & Partial<ListboxItemDescriptionCommonProps<ElementOf<T>>>
...
export function ListboxItemDescription<T extends ValidComponent = "div">(
  ...
  return <Polymorphic<ListboxItemDescriptionRenderProps> as="div" {...context.dataset()} {...mergedProps} />
}
