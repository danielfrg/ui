import { type OverrideComponentProps, focusWithoutScrolling, mergeRefs } from "../utils"
...
export interface SelectContentCommonProps<T extends HTMLElement = HTMLElement> extends DismissableLayerCommonProps<T> {
  style?: JSX.CSSProperties | string
}

export interface SelectContentRenderProps
  extends SelectContentCommonProps, SelectDataSet, DismissableLayerRenderProps {}

export type SelectContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = SelectContentOptions &
  Partial<SelectContentCommonProps<ElementOf<T>>>
...
export function SelectContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, SelectContentProps<T>>) {
  ...
  return (
    <Show when={context.contentPresent()}>
      <Popper.Positioner>
        <DismissableLayer<Component<Omit<SelectContentRenderProps, keyof DismissableLayerRenderProps>>>
          ref={mergeRefs((el) => {
