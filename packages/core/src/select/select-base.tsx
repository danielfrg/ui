...
import { type CollectionNode, createDisclosureState, createFormResetListener, createRegisterId } from "../primitives"
import {
  type FocusStrategy,
...
import { SelectContext, type SelectContextValue, type SelectDataSet } from "./select-context"
...
export interface SelectBaseOptions<Option, OptGroup = never> extends Omit<
  PopperRootOptions,
...
export interface SelectBaseRenderProps extends SelectBaseCommonProps, SelectDataSet, FormControlDataSet {
  role: "group"
}
...
> = SelectBaseOptions<Option, OptGroup> & Partial<SelectBaseCommonProps<ElementOf<T>>>

/**
 * Base component for a select, provide context for its children.
 * Used to build single and multi-select.
 */
export function SelectBase<Option, OptGroup = never, T extends ValidComponent = "div">(
