...
export interface SelectTriggerCommonProps<T extends HTMLElement = HTMLElement> extends Button.ButtonRootCommonProps<T> {
  id: string
  ref: T | ((el: T) => void)
...
export interface SelectTriggerRenderProps
  extends SelectTriggerCommonProps, SelectDataSet, FormControlDataSet, Button.ButtonRootRenderProps {
  "aria-haspopup": "listbox"
  "aria-expanded": boolean
  "aria-controls": string | undefined
}

export type SelectTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = SelectTriggerOptions &
  Partial<SelectTriggerCommonProps<ElementOf<T>>>
...
export function SelectTrigger<T extends ValidComponent = "button">(props: PolymorphicProps<T, SelectTriggerProps<T>>) {
  ...
  createEffect(() => {
    context.setListboxAriaLabelledBy(
      [fieldProps.ariaLabelledBy(), fieldProps.ariaLabel() && !fieldProps.ariaLabelledBy() ? fieldProps.id() : null]
        .filter(Boolean)
        .join(" ") || undefined,
    )
  })
  ...
  return (
    <Button.Root<Component<Omit<SelectTriggerRenderProps, keyof Button.ButtonRootRenderProps>>>
