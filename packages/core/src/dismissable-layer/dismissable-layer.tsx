...
import { contains, getDocument, mergeRefs } from "../utils"
import { type Accessor, type ValidComponent, createEffect, on, onCleanup, onMount, splitProps } from "solid-js"
...
export interface DismissableLayerCommonProps<T extends HTMLElement = HTMLElement> {
  ref: T | ((el: T) => void)
}
...
export function DismissableLayer<T extends ValidComponent = "div">(
  ...
  return (
    <DismissableLayerContext.Provider value={context}>
      <Polymorphic<DismissableLayerRenderProps> as="div" ref={mergeRefs((el) => (ref = el), local.ref)} {...others} />
