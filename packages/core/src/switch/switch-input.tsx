...
export interface SwitchInputCommonProps<T extends HTMLElement = HTMLInputElement> {
  id: string
  ref: T | ((el: T) => void)
...
export interface SwitchInputRenderProps extends SwitchInputCommonProps, FormControlDataSet, SwitchDataSet {
  type: "checkbox"
  role: "switch"
  name: string
  value: string
...
export type SwitchInputProps<T extends ValidComponent | HTMLElement = HTMLInputElement> = SwitchInputOptions &
  Partial<SwitchInputCommonProps<ElementOf<T>>>

/**
 * The native html input that is visually hidden in the switch.
 */
export function SwitchInput<T extends ValidComponent = "input">(props: PolymorphicProps<T, SwitchInputProps<T>>) {
  const formControlContext = useFormControlContext()
  const context = useSwitchContext()

  const mergedProps = mergeDefaultProps({ id: context.generateId("input") }, props as SwitchInputProps)
