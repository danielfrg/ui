...
export interface MeterFillRenderProps extends MeterFillCommonProps, MeterDataSet {}

export type MeterFillProps<T extends ValidComponent | HTMLElement = HTMLElement> = MeterFillOptions &
  Partial<MeterFillCommonProps<ElementOf<T>>>

/**
 * The component that visually represents the meter value.
 * Used to visually show the fill of `Meter.Track`.
 */
export function MeterFill<T extends ValidComponent = "div">(props: PolymorphicProps<T, MeterFillProps<T>>) {
