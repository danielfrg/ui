...
import { type OverrideComponentProps, createGenerateId, mergeDefaultProps } from "../utils"
import { type JSX, type ValidComponent, createMemo, createSignal, createUniqueId, splitProps } from "solid-js"
...
export type ToastRegionProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToastRegionOptions &
  Partial<ToastRegionCommonProps<ElementOf<T>>>
 ...
 */
export function ToastRegion<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastRegionProps<T>>) {
