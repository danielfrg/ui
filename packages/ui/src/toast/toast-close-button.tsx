...
export interface ToastCloseButtonCommonProps<T extends HTMLElement = HTMLElement> {
  "aria-label": string
...
export type ToastCloseButtonProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToastCloseButtonOptions &
