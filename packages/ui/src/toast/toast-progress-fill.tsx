import { type JSX, type ValidComponent, createEffect, createSignal, onCleanup, splitProps } from "solid-js"
...
export interface ToastProgressFillCommonProps<T extends HTMLElement = HTMLElement> {
  style?: JSX.CSSProperties | string
}

export interface ToastProgressFillRenderProps extends ToastProgressFillCommonProps {}

export type ToastProgressFillProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToastProgressFillOptions &
