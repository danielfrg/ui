...
import { callHandler, mergeRefs, visuallyHiddenStyles } from "../utils"
import { type ComponentProps, For, Show, createEffect, createSignal, on, splitProps } from "solid-js"
      ...
      <select
        ...
        onChange={(e) => {
          ...
          if (!isInternalChangeEvent()) {
            ...
            local.selectionManager.setSelectedKeys(new Set([(e.target as HTMLSelectElement).value]))
          }
