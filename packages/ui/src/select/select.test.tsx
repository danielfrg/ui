  ...
  it("renders correctly", () => {
    const { getByRole, getByText } = render(() => (
      <Select.Root
        ...
        itemComponent={(props) => <Select.Item item={props.item}>{props.item.rawValue.label}</Select.Item>}
      >
        <Select.HiddenSelect />
    ...
    it("supports string based option mapping for object options with string keys", async () => {
      const { getByRole, getAllByRole } = render(() => (
        <Select.Root<any, any>
          ...
          itemComponent={(props) => <Select.Item item={props.item}>{props.item.rawValue.name}</Select.Item>}
  ...
  describe("selection", () => {
    ...
    it("supports controlled clear selection", async () => {
      const { getByRole, getByTestId } = render(() => {
        ...
        return (
          <>
            <button type="button" data-testid="clear-button" onClick={() => setValue(null as any)}>
              Clear selection
            </button>
            <Select.Root
              options={DATA_SOURCE}
