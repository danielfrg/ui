...
import { type Component, type JSX, type ValidComponent, createEffect, onCleanup, splitProps } from "solid-js"

import * as Listbox from "../listbox"
import type { ListboxRootCommonProps, ListboxRootRenderProps } from "../listbox"
import type { ElementOf, PolymorphicProps } from "../polymorphic"
import { useSelectContext } from "./select-context"

export interface SelectListboxOptions<Option, OptGroup = never> extends Pick<
  Listbox.ListboxRootOptions<Option, OptGroup>,
  "scrollRef" | "scrollToItem" | "children"
> {}

export interface SelectListboxCommonProps<T extends HTMLElement = HTMLElement> extends ListboxRootCommonProps<T> {
  "aria-labelledby": string | undefined
}

export interface SelectListboxRenderProps extends SelectListboxCommonProps, ListboxRootRenderProps {}

export type SelectListboxProps<
  Option,
  OptGroup = never,
  T extends ValidComponent | HTMLElement = HTMLElement,
> = SelectListboxOptions<Option, OptGroup> & Partial<SelectListboxCommonProps<ElementOf<T>>>

/**
 * Contains all the items of a `Select`.
 */
export function SelectListbox<Option = any, OptGroup = never, T extends ValidComponent = "ul">(
  ...
  return (
    <Listbox.Root<Option, OptGroup, Component<Omit<SelectListboxRenderProps, keyof ListboxRootRenderProps>>>
