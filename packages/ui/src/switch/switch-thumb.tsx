...
export interface SwitchThumbRenderProps extends SwitchThumbCommonProps, FormControlDataSet, SwitchDataSet {}

export type SwitchThumbProps<T extends ValidComponent | HTMLElement = HTMLElement> = SwitchThumbOptions &
  Partial<SwitchThumbCommonProps<ElementOf<T>>>
