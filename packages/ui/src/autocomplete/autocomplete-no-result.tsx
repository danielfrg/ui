...
export interface AutocompleteNoResultCommonProps<
	T extends HTMLElement = HTMLElement,
> {}

export interface AutocompleteNoResultRenderProps
	extends AutocompleteNoResultCommonProps {}

export type AutocompleteNoResultProps<
	T extends ValidComponent | HTMLElement = HTMLElement,
> = AutocompleteNoResultOptions &
	Partial<AutocompleteNoResultCommonProps<ElementOf<T>>>;
