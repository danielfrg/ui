...
export interface AutocompleteIndicatorCommonProps<
...
export interface AutocompleteIndicatorRenderProps
	extends AutocompleteIndicatorCommonProps {}

export type AutocompleteIndicatorProps<
	T extends ValidComponent | HTMLElement = HTMLElement,
> = AutocompleteIndicatorOptions &
	Partial<AutocompleteIndicatorCommonProps<ElementOf<T>>>;
