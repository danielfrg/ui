...
describe("Autocomplete", () => {
  ...
  it("renders correctly", () => {
    ...
    const { getByRole, getByText, getByPlaceholderText } = render(() => (
      <Autocomplete.Root
        ...
        itemComponent={(props) => <Autocomplete.Item item={props.item}>{props.item.rawValue.label}</Autocomplete.Item>}
      >
        <Autocomplete.HiddenSelect />
    ...
    it("supports description", () => {
      const { getByRole, getByText } = render(() => (
        <Autocomplete.Root
          ...
          itemComponent={(props) => (
            <Autocomplete.Item item={props.item}>{props.item.rawValue.label}</Autocomplete.Item>
          )}
        >
          <Autocomplete.Label>Label</Autocomplete.Label>
          <Autocomplete.Control>
  ...
  describe("autofill", () => {
    it("should have a hidden select element for form autocomplete", async () => {
      ...
      const { getByRole, getAllByRole } = render(() => (
        ...
        >
          <Autocomplete.HiddenSelect autocomplete="address-level1" />
          <Autocomplete.Label>Label</Autocomplete.Label>
          <Autocomplete.Control>
            <Autocomplete.Input />
          </Autocomplete.Control>
    ...
    it("should have a hidden input to marshall focus to the Autocomplete input", async () => {
  ...
  describe("form", () => {
    it("Should submit empty option by default", async () => {
      let value: FormDataEntryValue | undefined
