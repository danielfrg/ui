...
export interface InputFieldRenderProps
	extends InputFieldCommonProps,
		FormControlDataSet {
	name: string;
...
> = InputFieldOptions & Partial<InputFieldCommonProps<ElementOf<T>>>;

export function InputField<T extends ValidComponent = "input">(
	props: PolymorphicProps<T, InputFieldProps<T>>,
) {
	return <InputFieldBase type="text" {...(props as InputFieldProps)} />;
}

export function InputFieldBase<T extends ValidComponent = "input">(
	props: PolymorphicProps<T, InputFieldProps<T>>,
) {
