...
export interface AccordionContentRenderProps
  extends AccordionContentCommonProps, Collapsible.CollapsibleContentRenderProps {
  role: "region"
  "aria-labelledby": string | undefined
}

export type AccordionContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = AccordionContentOptions &
...
export function AccordionContent<T extends ValidComponent = "div">(
  ...
  const mergedProps = mergeDefaultProps({ id: defaultId }, props as AccordionContentProps)
  ...
  return (
    <Collapsible.Content<Component<Omit<AccordionContentRenderProps, keyof Collapsible.CollapsibleContentRenderProps>>>
      role="region"
