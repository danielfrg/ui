...
export interface AccordionTriggerRenderProps
  extends AccordionTriggerCommonProps, Collapsible.CollapsibleTriggerRenderProps {
  "data-key": string | undefined
}

export type AccordionTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = AccordionTriggerOptions &
...
export function AccordionTrigger<T extends ValidComponent = "button">(
  ...
  const mergedProps = mergeDefaultProps({ id: defaultId }, props as AccordionTriggerProps)
  ...
  return (
    <Collapsible.Trigger<Component<Omit<AccordionTriggerRenderProps, keyof Collapsible.CollapsibleTriggerRenderProps>>>
