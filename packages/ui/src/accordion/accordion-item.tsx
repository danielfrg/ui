...
import { type Component, type JSX, type ValidComponent, createSignal, createUniqueId, splitProps } from "solid-js"

import * as Collapsible from "../collapsible"
import { type ElementOf, type PolymorphicProps } from "../polymorphic"
import { createRegisterId } from "../primitives"
import { useAccordionContext } from "./accordion-context"
import { AccordionItemContext, type AccordionItemContextValue } from "./accordion-item-context"
...
export interface AccordionItemRenderProps extends AccordionItemCommonProps, Collapsible.CollapsibleRootRenderProps {}

export type AccordionItemProps<T extends ValidComponent | HTMLElement = HTMLElement> = AccordionItemOptions &
...
export function AccordionItem<T extends ValidComponent = "div">(props: PolymorphicProps<T, AccordionItemProps<T>>) {
  ...
  const mergedProps = mergeDefaultProps({ id: defaultId }, props as AccordionItemProps)
  ...
  return (
    <AccordionItemContext.Provider value={context}>
      <Collapsible.Root<Component<Omit<AccordionItemRenderProps, keyof Collapsible.CollapsibleRootRenderProps>>>
        open={isExpanded()}
