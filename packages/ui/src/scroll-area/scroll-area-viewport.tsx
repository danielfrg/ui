...
import { type JSX, type ValidComponent, createEffect, on, onCleanup, splitProps } from "solid-js"
...
export interface ScrollAreaViewportCommonProps<T extends HTMLElement = HTMLElement> {
  ref: T | ((el: T) => void)
  style: JSX.CSSProperties | string
  onScroll: JSX.EventHandlerUnion<T, Event>
}

export interface ScrollAreaViewportRenderProps extends ScrollAreaViewportCommonProps {}

export type ScrollAreaViewportProps<T extends ValidComponent | HTMLElement = HTMLElement> = ScrollAreaViewportOptions &
...
export function ScrollAreaViewport<T extends ValidComponent = "div">(
  ...
  const [local, others] = splitProps(props as ScrollAreaViewportProps, ["ref", "style"])
