...
> = ScrollAreaRootOptions & Partial<ScrollAreaRootCommonProps<ElementOf<T>>>;
...
export function ScrollAreaRoot<T extends ValidComponent = "div">(
	...
	const [local, others] = splitProps(props as ParentProps<ScrollAreaRootProps>, [
		"ref",
		"style",
	]);
	...
	function handlePointerMove(e: PointerEvent) {
		...
		if (dragOrientation === "vertical") {
			...
			viewport.scrollLeft =
				startScrollLeft +
				scrollRatio * (viewport.scrollWidth - viewport.clientWidth);
		}
	}
