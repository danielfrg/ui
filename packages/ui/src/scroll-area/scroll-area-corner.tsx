...
export interface ScrollAreaCornerCommonProps<T extends HTMLElement = HTMLElement> {}

export interface ScrollAreaCornerRenderProps extends ScrollAreaCornerCommonProps {}

export type ScrollAreaCornerProps<T extends ValidComponent | HTMLElement = HTMLElement> = ScrollAreaCornerOptions &
