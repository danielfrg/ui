...
import { callHandler, createGenerateId, mergeDefaultProps } from "../utils"
import {
  type Accessor,
  type JSX,
  type ValidComponent,
...
export interface RadioGroupItemCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  onPointerDown: JSX.EventHandlerUnion<T, PointerEvent>
}

export interface RadioGroupItemRenderProps extends RadioGroupItemCommonProps, RadioGroupItemDataSet {
  role: "group"
}

export type RadioGroupItemProps<T extends ValidComponent | HTMLElement = HTMLElement> = RadioGroupItemOptions &
  Partial<RadioGroupItemCommonProps<ElementOf<T>>>

/**
 * The root container for a radio button.
 */
export function RadioGroupItem<T extends ValidComponent = "div">(props: PolymorphicProps<T, RadioGroupItemProps<T>>) {
