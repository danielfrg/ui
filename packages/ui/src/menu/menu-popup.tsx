...
export interface DropdownMenuPopupCommonProps<
	T extends HTMLElement = HTMLElement,
> extends MenuContentCommonProps<T> {}

export interface DropdownMenuPopupRenderProps
	extends DropdownMenuPopupCommonProps,
		MenuContentRenderProps {}

export type DropdownMenuPopupProps<
...
export function DropdownMenuPopup<T extends ValidComponent = "div">(
	...
	return (
		<MenuContent<
			Component<
				Omit<DropdownMenuPopupRenderProps, keyof MenuContentRenderProps>
			>
		>
