...
export interface NumberFieldIncrementTriggerRenderProps
  extends NumberFieldIncrementTriggerCommonProps, NumberFieldVaryTriggerRenderProps {}

export type NumberFieldIncrementTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NumberFieldIncrementTriggerOptions & Partial<NumberFieldIncrementTriggerCommonProps<ElementOf<T>>>
...
export function NumberFieldIncrementTrigger<T extends ValidComponent = "button">(
  ...
  return (
    <NumberFieldVaryTrigger<
      Component<Omit<NumberFieldIncrementTriggerRenderProps, keyof NumberFieldVaryTriggerRenderProps>>
    >
