...
export interface AvatarFallbackCommonProps<
...
> = AvatarFallbackOptions & Partial<AvatarFallbackCommonProps<ElementOf<T>>>;

/**
 * An element that renders when the image hasn't loaded.
 * This means whilst it's loading, or if there was an error.
 */
export function AvatarFallback<T extends ValidComponent = "span">(
	...
	return (
		<Show when={canRender() && context.imageLoadingStatus() !== "loaded"}>
			<Polymorphic<AvatarFallbackRenderProps>
				as="span"
