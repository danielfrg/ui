...
export interface DialogCloseButtonRenderProps extends DialogCloseButtonCommonProps, Button.ButtonRootRenderProps {}
...
export function DialogCloseButton<T extends ValidComponent = "button">(
  ...
  const [local, others] = splitProps(props as DialogCloseButtonProps, ["aria-label", "onClick"])
  ...
  return (
    <Button.Root<Component<Omit<DialogCloseButtonRenderProps, keyof Button.ButtonRootRenderProps>>>
