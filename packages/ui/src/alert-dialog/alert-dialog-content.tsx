...
export interface AlertDialogContentRenderProps extends AlertDialogContentCommonProps, DialogContentRenderProps {
  role: "alertdialog"
}

export type AlertDialogContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = AlertDialogContentOptions &
...
export function AlertDialogContent<T extends ValidComponent = "div">(
  ...
  return (
    <DialogContent<Component<Omit<AlertDialogContentRenderProps, Exclude<keyof DialogContentRenderProps, "role">>>>
      role="alertdialog"
