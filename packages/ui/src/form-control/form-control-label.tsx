...
export interface FormControlLabelCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
}

export interface FormControlLabelRenderProps extends FormControlLabelCommonProps, FormControlDataSet {
  for: string | undefined
}

export type FormControlLabelProps<T extends ValidComponent | HTMLElement = HTMLElement> = FormControlLabelOptions &
