...
import { type MenuDataSet, useMenuContext } from "../menubar/menu-context"
...
export type ContextMenuTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = ContextMenuTriggerOptions &
