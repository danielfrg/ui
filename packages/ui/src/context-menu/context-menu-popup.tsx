...
export interface ContextMenuPopupCommonProps<
	T extends HTMLElement = HTMLElement,
> extends MenuContentCommonProps<T> {}

export interface ContextMenuPopupRenderProps
	extends ContextMenuPopupCommonProps,
...
export function ContextMenuPopup<T extends ValidComponent = "div">(
	...
	return (
		<MenuContent<
			Component<
				Omit<ContextMenuPopupRenderProps, keyof MenuContentRenderProps>
			>
		>
