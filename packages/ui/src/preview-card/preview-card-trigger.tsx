...
import { type Component, type JSX, type ValidComponent, onCleanup, splitProps } from "solid-js"
...
export interface PreviewCardTriggerCommonProps<T extends HTMLElement = HTMLElement> {
  disabled: boolean
  ref: T | ((el: T) => void)
...
export interface PreviewCardTriggerRenderProps
  extends PreviewCardTriggerCommonProps, Link.LinkRootRenderProps, PreviewCardDataSet {}

export type PreviewCardTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = PreviewCardTriggerOptions &
...
export function PreviewCardTrigger<T extends ValidComponent = "a">(
  ...
  return (
    <Link.Root<Component<Omit<PreviewCardTriggerRenderProps, keyof Link.LinkRootRenderProps>>>
