...
export interface PreviewCardContentCommonProps<
...
export interface PreviewCardContentRenderProps
	extends PreviewCardContentCommonProps,
...
export function PreviewCardContent<T extends ValidComponent = "div">(
	...
	const [local, others] = splitProps(props as PreviewCardContentProps, [
		"ref",
		"style",
	]);
	...
	return (
		<Show when={context.contentPresent()}>
			<Popper.Positioner>
				<DismissableLayer<
					Component<
						Omit<PreviewCardContentRenderProps, keyof DismissableLayerRenderProps>
					>
				>
					ref={mergeRefs((el) => {
