...
export type MenuItemDescriptionProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  MenuItemDescriptionOptions & Partial<MenuItemDescriptionCommonProps<ElementOf<T>>>
