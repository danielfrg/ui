...
export interface MenuBarTriggerCommonProps<T extends HTMLElement = HTMLElement> extends MenuTriggerCommonProps<T> {}

export interface MenuBarTriggerRenderProps extends MenuBarTriggerCommonProps, MenuTriggerRenderProps {}

export type MenuBarTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> = MenuBarTriggerOptions &
  Partial<MenuBarTriggerCommonProps<ElementOf<T>>>
...
export function MenuBarTrigger<T extends ValidComponent = "button">(
  ...
  if (menuContext === undefined && menuBarContext !== undefined && (props as any).href !== undefined) {
