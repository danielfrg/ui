...
export type NavigationMenuContentProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NavigationMenuContentOptions & Partial<NavigationMenuContentCommonProps<ElementOf<T>>>
  ...
  createEffect(
    on(menubarContext.value, (contextValue) => {
      batch(() => {
        ...
        // When currently active menu set `from-*` motion if there is a previous then update previous menu
