...
import { type Accessor, type ParentProps, createEffect, createSignal, onCleanup } from "solid-js"
...
export function PopperRoot(props: PopperRootProps) {
  ...
  async function updatePosition() {
    ...
    const finalGutter =
      typeof mergedProps.gutter === "number" ? mergedProps.gutter + arrowOffset : (mergedProps.gutter ?? arrowOffset)
    ...
    if (mergedProps.flip !== false) {
      ...
      const fallbackPlacements = typeof flipValue === "string" ? flipValue.split(" ") : undefined
