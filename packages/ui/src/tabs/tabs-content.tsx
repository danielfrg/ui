...
import { type Orientation, getFocusableTreeWalker, mergeRefs } from "../utils"
import { Show, type ValidComponent, createEffect, createSignal, on, onCleanup, splitProps } from "solid-js"
...
export type TabsContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = TabsContentOptions &
  Partial<TabsContentCommonProps<ElementOf<T>>>
...
export function TabsContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, TabsContentProps<T>>) {
  ...
  const [local, others] = splitProps(props as TabsContentProps, ["ref", "id", "value", "forceMount"])
