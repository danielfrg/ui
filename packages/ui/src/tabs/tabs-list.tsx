...
import { type JSX, type ValidComponent, createEffect, splitProps } from "solid-js"
...
export type TabsListProps<T extends ValidComponent | HTMLElement = HTMLElement> = TabsListOptions &
  Partial<TabsListCommonProps<ElementOf<T>>>
...
export function TabsList<T extends ValidComponent = "div">(props: PolymorphicProps<T, TabsListProps<T>>) {
  ...
  createEffect(() => {
    ...
    const selectedTab = ref.querySelector(`[data-key="${context.listState().selectedKey()}"]`) as HTMLElement | null
