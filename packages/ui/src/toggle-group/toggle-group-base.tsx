import { type Orientation, composeEventHandlers, createGenerateId, mergeDefaultProps, mergeRefs } from "../utils"
...
import { ToggleGroupContext, type ToggleGroupContextValue } from "./toggle-group-context"
...
export interface ToggleGroupBaseCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
...
export type ToggleGroupBaseProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToggleGroupBaseOptions &
  Partial<ToggleGroupBaseCommonProps<ElementOf<T>>>

export function ToggleGroupBase<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToggleGroupBaseProps<T>>) {
